...
I have the function created for the global and country summaries. Add in the regions to allow the user to select a specific region for the countries, can't do that for the global one
...
* `countrycode`: this lets us tie the country name to the continent which is defined by the World Bank Development Indicators   
